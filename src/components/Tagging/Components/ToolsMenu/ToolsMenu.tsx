        ...
        return <div className="tool-bar">
            <div className="audio-options">
                <span className="tooltip">
                    <button className="tool-btn" onClick={toolsStore.handlePlay}><img src="./assets/tool-bar-assets/play-icon.svg" 
                    alt="" ></img></button>
                    <span className="tooltiptext">Reproducir</span>
                </span>
                <span className="tooltip">
                    <button className="tool-btn" onClick={toolsStore.handlePause}><img src="./assets/tool-bar-assets/pause-icon.svg" 
                    alt="" ></img></button>
